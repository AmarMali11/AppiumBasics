...
public class VerifyAddProductCard {
	...
	public void fillForm() throws Throwable
	{
		...
		int numberOfProductInpage =driver.findElements(By.id("com.androidsample.generalstore:id/productName")).size();
		
		for(int i=0;i<numberOfProductInpage;i++)
		{
		  ...
		  Thread.sleep(5000);
		  String productNameInCard=driver.findElement(By.id("com.androidsample.generalstore:id/productName")).getText();
		  
		  Assert.assertEquals(productNameInCard, "Jordan 6 Rings");
